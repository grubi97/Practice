...
export default function ActivityDashboard({submitting,activities,selectedActivity,cancelSelectActivity,selectActivity,editMode,openForm,closeForm,createOrEdit,deleteActivity}:Props){
